                    ...
                    children: [
                      ...
                      Expanded(
                        child: DoubleTextFormField(
                          ...
                          keyboardType: TextInputType.number,
                          onChanged: (val) => limit.minLimit = val,
                        ),
                      ),
                      const SizedBox(width: 8),
                      _buildTodoFlag(
                      ...
                      Expanded(
                        child: DoubleTextFormField(
                          ...
                          keyboardType: TextInputType.number,
                          onChanged: (val) => limit.maxLimit = val,
                        ),
                      ),
                      IconButton(
                        icon: const Icon(Icons.delete, color: Colors.redAccent),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: DoubleTextFormField(
                          ...
                          keyboardType: TextInputType.number,
                          onChanged: (val) => autoCalibration.autoResetPos = val,
                        ),
                      ),
                      IconButton(
                        icon: const Icon(Icons.delete, color: Colors.redAccent),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: DoubleTextFormField(
                              ...
                              keyboardType: TextInputType.number,
                              onChanged: (val) => cmd.resetPos = val,
                            ),
                          ),
                        ],
                      ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: DoubleTextFormField(
                                ...
                                keyboardType: TextInputType.number,
                                onChanged: (val) => cmd.startPower = val,
                              ),
                            ),
                            const SizedBox(width: 8),
                            _buildTodoFlag(
                            ...
                            Expanded(
                              child: DoubleTextFormField(
                                ...
                                keyboardType: TextInputType.number,
                                onChanged: (val) => cmd.startDelaySec = val,
                              ),
                            ),
                          ],
                        ),
